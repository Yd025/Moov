...
export const workoutPlans = [
  ...
  // Standard body part focused workout plans
  {
    id: 'legs_workout',
    name: 'Legs Workout',
    description: 'Comprehensive leg strengthening routine targeting quads, hamstrings, and calves',
    exerciseIds: ['squats', 'lunges', 'leg_lifts', 'calf_raises', 'leg_extensions', 'side_leg_raises'],
    tags: ['legs', 'lower_body', 'intermediate'],
    difficulty: 'intermediate',
    estimatedDuration: 510,
    focusArea: 'legs',
  },
  {
    id: 'legs_workout_seated',
    name: 'Legs Workout (Seated)',
    description: 'Leg exercises you can do while seated',
    exerciseIds: ['leg_lifts', 'leg_extensions', 'side_leg_raises', 'ankle_circles'],
    tags: ['legs', 'lower_body', 'seated', 'wheelchair_friendly', 'beginner'],
    difficulty: 'beginner',
    estimatedDuration: 270,
    focusArea: 'legs',
  },
  {
    id: 'arms_workout',
    name: 'Arms Workout',
    description: 'Build arm strength with biceps, triceps, and shoulder exercises',
    exerciseIds: ['bicep_curls', 'tricep_dips', 'arm_raises', 'arm_circles', 'pushups', 'wall_pushups'],
    tags: ['arms', 'upper_body', 'intermediate'],
    difficulty: 'intermediate',
    estimatedDuration: 480,
    focusArea: 'arms',
  },
  {
    id: 'arms_workout_seated',
    name: 'Arms Workout (Seated)',
    description: 'Arm exercises perfect for seated workouts',
    exerciseIds: ['bicep_curls', 'arm_raises', 'arm_circles', 'shoulder_rolls', 'hand_squeezes'],
    tags: ['arms', 'upper_body', 'seated', 'wheelchair_friendly', 'beginner'],
    difficulty: 'beginner',
    estimatedDuration: 330,
    focusArea: 'arms',
  },
  {
    ...
    exerciseIds: ['back_extensions', 'superman', 'shoulder_blade_squeezes', 'rows', 'shoulder_rolls'],
    tags: ['back', 'upper_body', 'intermediate'],
    difficulty: 'intermediate',
    estimatedDuration: 420,
    focusArea: 'back',
  },
  {
    id: 'back_workout_seated',
    name: 'Back Workout (Seated)',
    description: 'Back strengthening exercises for seated positions',
    exerciseIds: ['back_extensions', 'shoulder_blade_squeezes', 'shoulder_rolls', 'neck_stretches'],
    tags: ['back', 'upper_body', 'seated', 'wheelchair_friendly', 'beginner'],
    difficulty: 'beginner',
  ...
  {
    id: 'abdomen_workout',
    name: 'Abdomen Workout',
    description: 'Core strengthening routine targeting your abdominal muscles',
    exerciseIds: ['crunches', 'plank', 'leg_raises', 'bicycle_crunches', 'dead_bug', 'seated_twists'],
    tags: ['abdomen', 'core', 'intermediate'],
    difficulty: 'intermediate',
    estimatedDuration: 480,
    focusArea: 'abdomen',
  },
  {
    id: 'abdomen_workout_seated',
    name: 'Abdomen Workout (Seated)',
    description: 'Core exercises you can do while seated',
    exerciseIds: ['seated_twists', 'back_extensions', 'leg_lifts'],
    tags: ['abdomen', 'core', 'seated', 'wheelchair_friendly', 'beginner'],
    difficulty: 'beginner',
